...
--
-- Table structure for table `sis_academic_grade`
--

DROP TABLE IF EXISTS `sis_academic_grade`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sis_academic_grade` (
  ...
  PRIMARY KEY (`id`,`schoolYear`,`term`,`courseNumber`,`courseName`,`grade`,`districtId`)
