...
public class MelissaSisFiles {
   @Autowired
    ...
    private static MelissaSisFiles i;  // instance
    ...
    public static ImportResult Import(String importDefId) {
        ...
        try {
            ...
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/24-25 MAP/Fall 2024 district scores.csv", false);
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/24-25 MAP/Spring 25 district scores.csv", false);
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/24-25 MAP/Winter 25 district scores.csv", false);

            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/23-24 MAP/2024_Winter_Map_ComboStudentAssessment (1).csv", false);
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/23-24 MAP/Fall23_24MAPComboStudentAssessment.csv", false);
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/23-24 MAP/Spring2024_MAP_ComboStudentAssessment.csv", false);


            //this one has an empty level, but we skip.
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/22-23 MAP/MAP_Fall_22_23ComboStudentAssessment.csv", false);
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/22-23 MAP/MOY_MAP_22_23_ComboStudentAssessment.csv", false);
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/22-23 MAP/Spring_22_23_ComboStudentAssessment.csv", false);

            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/21-22 MAP/Spring_2022_MAP_ComboStudentAssessment.csv", false);
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/21-22 MAP/Winter_21_22_ComboStudentAssessment (1).csv", false);
            CsvFiles.LoadComboStudentAssessment(districtId, "C:/test/importBase/tea/21-22 MAP/Winter_21_22_ComboStudentAssessment.csv", false);
