...
public class ClassLinkOneRoster {

    private String clientId;
    private String clientSecret;

    public ClassLinkOneRoster(String clientId, String clientSecret) {
     ...
     */
    public ClassLinkOneRosterResponse makeRosterRequest(String url) {
     ...
     */
    private ClassLinkOneRosterResponse makeGetRequest(String url, String header) {
        try {
            ...
            try {
                ...
                in.close();
                return new ClassLinkOneRosterResponse(responseCode, res);
            } catch (IOException e) {
                try {
                    if (connection != null) {
                        BufferedReader in = new BufferedReader(
                        ...
                        String res = response.toString();
                        in.close();
                        return new ClassLinkOneRosterResponse(connection.getResponseCode(), res);
                    } else {
                        return new ClassLinkOneRosterResponse(0, "No connection found");
                    }


                } catch (Exception ex) {
                    return new ClassLinkOneRosterResponse(0, "An error occurred, check your url");
